...
class AritclesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aritcle" do
    assert_difference('Aritcle.count') do
      post aritcles_url, params: { aritcle: { post: @aritcle.post, title: @aritcle.title, user_id: @aritcle.user_id } }
    end
  ...
  test "should update aritcle" do
    patch aritcle_url(@aritcle), params: { aritcle: { post: @aritcle.post, title: @aritcle.title, user_id: @aritcle.user_id } }
